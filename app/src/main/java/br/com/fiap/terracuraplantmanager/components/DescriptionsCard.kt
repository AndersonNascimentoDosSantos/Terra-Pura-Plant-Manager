...
@Composable
fun DescriptionsCard(

    descriptions: JSONObject? = null,
...
//        elevation = 4.dp // Ajuste o valor da elevação para controlar a sombra
        ...
        val hasDescriptions = descriptions != null
            ...
            if (hasDescriptions) {
                ...
                Row(
                    ...
                    if (descriptions != null) {
                        Text(
                            text = descriptions.optString("value"), modifier = Modifier,
